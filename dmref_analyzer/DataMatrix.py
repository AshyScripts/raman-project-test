...
default_param_rule = pd.read_csv(
    os.path.expanduser("~/Desktop/project/raman-ashkan/parameter_rules.csv"), index_col=1
)
...
default_input_dir = os.path.expanduser("~/Desktop/project/raman-ashkan")
    ...
    def __init__(
        ...
        if data_frame is None:
            ...
            if self.experiment_type in ["genRF", "genR"]:
                ...
                self.matlab_engine.addpath("~/Desktop/project/raman-ashkan")
