...
def plot_dendro(X, labels, metric="euclidean"):
    ...
    # plt.rc('font', size=20)
    plt.savefig(
        "~/Desktop/project/raman-ashkan/tests/figures/dendro.png", dpi=600, bbox_inches="tight"
    )
    plt.savefig("~/Desktop/project/raman-ashkan/tests/figures/dendro.pdf", bbox_inches="tight")
